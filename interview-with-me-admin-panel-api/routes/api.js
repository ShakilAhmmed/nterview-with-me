...
import * as courseContentCategoryController
    from "../src/controllers/api/v1/courseContentCategory/courseContentCategoryController";
...
import * as participatorProgressController
    from "../src/controllers/api/v1/participatorProgress/participatorProgressController";
...
router.get('/frontend/fetch-category-wise-courses/:id', frontendApiController.fetchCategoryWiseCourse);
